 ...
 * @version GIT: $Id: Author: DrByte  Added in v1.5.5 $
 */
...
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_NOTAUTHED_MESSAGE', '<h3 class="ErrorInfo">Your card could not be authorised! Please try again, try another card or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_MALFORMED_MESSAGE', '<h3 class="ErrorInfo">Your card could not be reconised! Please try again, try another card or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_INVALID_MESSAGE', '<h3 class="ErrorInfo">Your card details could not be reconised! Please try again, try another card or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_ABORT_MESSAGE', '<h3 class="ErrorInfo">The Transaction could not be completed because the user clicked the CANCEL button on the payment pages, went inactive for 15 minutes or longer or there was a problem with the users internet connection to our servers.Please try again or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_REJECTED_MESSAGE', '<h3 class="ErrorInfo">Unable to continue! A problem has occurred with our systems. Please <strong><a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_ERROR_MESSAGE', '<h3 class="ErrorInfo">Unable to continue! A problem has occurred with our systems. Please <strong><a href="index.php?main_page=contact_us">contact the administrator</a></strong> for assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_DECLINED_MESSAGE', '<h3 class="ErrorInfo">Your card could not be authorised! Please try again or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.</h3><p class="ExtraErrorInfo">(%s)</p>');
